...
presdir <- file.path(basedir, "raster_layers", "present") # calls present data from raster files
futdir <- file.path(basedir, "raster_layers", "future") # calls future data from raster files
