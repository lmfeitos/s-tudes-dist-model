...
tiff(file="ensembled_binary_2.tiff", width = 3200, height = 3200, res = 400, compression = "lzw")
plot(gensemble[[1]])
points(ocor, pch=20) 
map(add=T)
dev.off()

tiff(file="ensembled_prob_2.tiff", width = 3200, height = 3200, res = 400, compression = "lzw")
plot(ensemble)
...
tiff(file="ensemble_prob_smaller_2.tiff", width = 3200, height = 3200, res = 400, compression = "lzw")
plot(fig.menor)
points(ocor, pch=20) #inserir pontos de ocorr?ncia no mapa
map(add=T)
dev.off()
