...
prob_pres_zoom_south <-
  ...
  annotate("text", label = "C",
           x = -69, y = -3, size = 5, color = "black") +
  scale_fill_viridis_c(breaks = seq(0, 18, by = 16),
                       labels = c("0%", "100%")) +
  coord_sf(xlim = c(-70, -30),
           ylim = c(-40, -5),
           expand = FALSE) +
  labs(x = "",
       y = "",
...
prob_pres <- 
  ...
  coord_sf(xlim = c(-108, -25),
   ...
   geom_polygon(data = data.frame("x" = c(-78, -78,
                ...
                color = "black",
                size = .7) +
   geom_polygon(data = data.frame("x" = c(-57, -57,
                                          -35, -35), 
                                  "y" = c(-40, -10, 
                                          -10, -40)),
                mapping = aes(x = x, y = y), 
                ...
                color = "black",
                size = .7) +
   geom_rect(xmin = -80, xmax = -30, ymin = -10, ymax = 20,
            fill = NA, color = "black", size = 1) +
  geom_rect(xmin = -70, xmax = -30, ymin = -40, ymax = -5,
            fill = NA, color = "black", size = 1) +
  labs(x = "",
       y = "",
       fill = "Suitability") +
...
ggplot() +
  ...
  annotation_custom(ggplotGrob(prob_pres_zoom_south),
                    xmin = 15, xmax = 30, ymin = 0, ymax = 9.5) +
...
```{r, fig.height=9, fig.width=11}
(prob_pres + plot_layout(guides = "auto") | (prob_pres_zoom_center / prob_pres_zoom_south)) +
...
ggsave(file.path(outdir, "composite_of_probability_with_all_vars_new_model.png"),
       width = 11, height = 9, dpi = 300)
```
